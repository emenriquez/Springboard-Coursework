...
#### Additional Optimization: Adjusting Class weights

One technique we can use in order to improve our model's performance on the classes that take up a smaller distribution of the overall dataset is to adjust the weight of those classes. This technique would impose a higher penalty on the model when misclassifying classes according to the weights we choose.
